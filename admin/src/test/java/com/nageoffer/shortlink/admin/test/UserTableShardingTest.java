...
public class UserTableShardingTest {
    public static final String SQL="CREATE TABLE `t_link_%d` (\n" +
            ...
            "  `origin_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '原始短链接',\n" +
            ...
            "  PRIMARY KEY (`id`),\n" +
            "  KEY `idx_unique_full-short-url` (`full_short_url`,`del_time`) USING BTREE\n" +
            ") ENGINE=InnoDB AUTO_INCREMENT=1866073640614498306 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;";
